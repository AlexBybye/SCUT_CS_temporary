...
- 🔴 高等目标：**建立有完备的支付逻辑的全栈平台**部署至华为云Server。此仓库中文件打包zip分学科发布在release中，全栈项目将其作为免费OSS，通过抓github的proxy国内镜像包来实现大文件下载。其余数据储存在此项目后端，我认为flask可能就足以支撑。**如果有相关自愿捐赠，将全额用于智能基座社团资金部分流转。**（可能用oAuth）
